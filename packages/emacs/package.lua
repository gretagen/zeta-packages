return {
  ...
  deps    = { "gtk3", "libX11", "libXpm", "libjpeg-turbo", "libpng", "libwebp", "sqlite", "cairo", "harfbuzz", "dbus", "libXrandr", "libXinerama", "libXfixes", "libXext", "libXcomposite", "libxcb", "libXi", "libxml2", "libtinfo", "freetype", "fontconfig", "lcms2", "systemd-libs", "libz" },
  archive = { strip = 1 },
  test    = function(p)
