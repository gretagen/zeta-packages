return {
  ...
  deps    = { "alsa-lib", "at-spi2-core", "cairo", "dbus", "expat", "glib", "gtk3", "gcc-libs", "libX11", "libXcomposite", "libXdamage", "libXext", "libXfixes", "libXrandr", "libxcb", "libcups", "systemd-libs", "mesa-drivers", "nss", "pango", "xkbcommon" },
  archive = { strip = 1 },
  test    = function(p)
