return {
  ...
  { name = "zeta", version = "1.0.6", summary = "Zeta package manager for Haliade OS" },
  ...
  { name = "zstrappa", version = "1.0", summary = "Install Haliade OS from the live ISO to a target device" },
}
