return {
  ...
  { name = "base", version = "1.0", summary = "Heliade OS base system (metapackage)" },
  ...
  { name = "filesystem", version = "1.0", summary = "Heliade OS base filesystem hierarchy (FHS)" },
  ...
  { name = "genkernel", version = "1.0", summary = "Heliade OS kernel generation script" },
  { name = "genzee", version = "1.0", summary = "btrfs generation manager for Heliade OS (Limine boot entries)" },
  ...
  { name = "heliade-utils", version = "1.0", summary = "Heliade OS utility scripts (metapackage)" },
  ...
  { name = "linux-bin", version = "7.1.10", summary = "Heliade OS kernel 7.1.10-gen (modules included)" },
  ...
  { name = "openrc", version = "0.63.3", summary = "OpenRC init system and service manager for Heliade OS" },
  ...
  { name = "subspace-scripts", version = "1.1.0", summary = "Heliade OS subspace management scripts" },
  ...
  { name = "zeta", version = "1.0.6", summary = "Zeta package manager for Heliade OS" },
  ...
  { name = "zstrappa", version = "1.0", summary = "Install Heliade OS from the live ISO to a target device" },
}
