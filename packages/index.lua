return {
  ...
  { name = "perl", version = "5.42.3", summary = "Perl interpreter (provided by the base system; stub package)" },
  ...
  { name = "zeta", version = "1.0.1", summary = "Zeta package manager for Zerene OS" },
