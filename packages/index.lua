return {
  ...
  { name = "filesystem", version = "1.0", summary = "Zerene OS base filesystem hierarchy (FHS)" },
  ...
  { name = "networkmanager", version = "1.51.4", summary = "Network connection manager and daemon (nmcli, nmtui)" },
  ...
  { name = "nvidia-open", version = "610.57.04", summary = "NVIDIA open GPU kernel modules (compiled against the running kernel at install time)" },
  ...
  { name = "subspace-scripts", version = "1.0", summary = "Zerene OS subspace management scripts" },
  ...
  { name = "zeta", version = "1.0.4", summary = "Zeta package manager for Zerene OS" },
  ...
  { name = "zstrappa", version = "1.0", summary = "Install Zerene OS from the live ISO to a target device" },
}
