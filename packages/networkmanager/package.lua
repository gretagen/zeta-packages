return {
  ...
  deps    = { "glib", "dbus", "libnl", "curl", "libndp", "libpsl", "systemd-libs", "libz", "iwd", "wpa_supplicant", "dnsmasq", "dhcpcd", "gobject-introspection", "polkit", "elogind", "libgudev", "ncurses", "newt", "nss" },
  archive = { strip = 1 },
  test    = function(p)
